...
//					putText(frame, text, Point(int(frame.cols*0.1), int(frame.rows*0.9)),
...
//						//putText(frame, text, pt, CV_FONT_HERSHEY_SCRIPT_SIMPLEX, 2.5f, color);
//						putText(frame, text, Point(int(frame.cols*0.1), int(frame.rows*0.9)),
//							CV_FONT_HERSHEY_DUPLEX, frame.cols / 300, cvScalar(0, 255, 0, 0), 3);//b,g,r
//					}
//					else if (flag >=120)
//					{
...
//						//putText(frame, text, pt, CV_FONT_HERSHEY_SCRIPT_SIMPLEX, 2.5f, color);
//						putText(frame, text, Point(int(frame.cols*0.1), int(frame.rows*0.9)),
//							CV_FONT_HERSHEY_DUPLEX, frame.cols / 300, cvScalar(0, 0, 255, 0), 3);
//					}
//					else
//					{
//						string text = "A.W.A.K.E";
